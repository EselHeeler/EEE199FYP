//libraries needed for the sensors and Mesh Network
#include <Wire.h>
#include <MQ135.h>
#include <Arduino.h>
#include "PMS.h"
...
//defining the pins of the sensors
...
// MESH Details
#define   MESH_PREFIX     "EEE199" 
#define   MESH_PASSWORD   "FYPMesh"
...
//Setting up the task and the mesh
Scheduler userScheduler;
painlessMesh  mesh;

//declaring of the variables for timer to check the speed
int t1,t2,t3;

// declaring the functions that will be used for getting the readings from the sensors and the sending it to the other nodes
void sendMessage() ;
String getReadings(); 
...
//the function for getting the readings from the sensors
String getReadings () {
...
//the function for sending the sensor data to the other nodes in the network
void sendMessage () {
...
//the function for setting up the sensors
void initSensors(){
...
// Functions for the painless library
// Function providing the task of printing the data once the node received a message from the other sensor nodes
